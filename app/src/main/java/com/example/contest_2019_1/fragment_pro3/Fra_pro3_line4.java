...
public class Fra_pro3_line4 extends Myfragment {
    ...
    Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            dataSet = new LineDataSet(list, "CQ2");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pro3_line4, container, false);
        this.view = view;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lineChart = view.findViewById(R.id.lineChart4);
        init();
    }
