...
public class Fra_pro3_line3 extends Myfragment {
    ...
    com.example.contest_2019_1.programme3 programme3;
    ...
    Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            dataSet = new LineDataSet(list, "光照");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pro3_line3, container, false);
        this.view = view;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lineChart = view.findViewById(R.id.lineChart3);
        init();
    }
